    ...
    [
        {
            ...
            "summary": "In particular, there is no sufficient evidence that deep learning machinery allows constructing methods that outperform gradient boosting decision trees, which are often the top choice for tabular problems. In this paper, we introduce Neural Oblivious Decision Ensembles , a new deep learning architecture, designed to work with any tabular data."
        },
        {
            "researchAreas": ["COMPUTER VISION"],
            "name": "Single-Network Whole-Body Pose Estimation",
            "authors": [
                "Gines Hidalgo",
                "Yaadhav Raaj",
                "Haroon Idrees",
            ...
            "summary": "We present the first single-network approach for 2D whole-body pose estimation, which entails simultaneous localization of body, face, hands, and feet keypoints. Our approach considerably improves upon Open Pose , the only work so far capable of whole-body pose estimation, both in terms of speed and global accuracy.",
        }
    ]
)